...
export default function HotelInLaPerlaPage() {
  ...
  return <><Header overlay /><main id="contenido">
    ...
    <RelatedLinks title="Elegí cómo vivir La Perla" links={[
      { href: "/habitaciones", eyebrow: "Hasta cinco huéspedes", title: "Habitaciones renovadas", copy: "Compará capacidades y encontrá la opción indicada.", event: "view_room" },
      { href: "/alojamiento-familiar", eyebrow: "Viajes compartidos", title: "Alojamiento familiar", copy: "Alternativas para familias de hasta cinco huéspedes." },
