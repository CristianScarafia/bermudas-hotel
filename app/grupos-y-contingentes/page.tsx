...
export default function GroupsPage() {
  ...
  return <><Header overlay /><main id="contenido">
    ...
    <section className="seo-lead section container"><div className="reveal"><p className="eyebrow">Propuesta personalizada</p><h2>Un solo contacto para organizar el alojamiento.</h2></div><div className="reveal"><p>Recibimos consultas de grupos familiares, deportivos, educativos y contingentes. La disponibilidad se evalúa según las fechas, el tamaño del grupo y la distribución necesaria.</p><p>Hotel Bermudas cuenta con 20 habitaciones dobles, triples y cuádruples. Su ubicación en La Perla permite estar cerca del mar y del centro de Mar del Plata.</p></div></section>
    ...
    <RelatedLinks links={[
      { href: "/habitaciones", eyebrow: "Capacidades", title: "Tipos de habitación", copy: "Conocé las opciones dobles, triples y cuádruples.", event: "view_room" },
