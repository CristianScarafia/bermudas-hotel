...
export const metadata: Metadata = {
  ...
  description: "Hotel familiar en La Perla, Mar del Plata, con habitaciones triples y cuádruples, desayuno, baño privado y ubicación cerca de la playa.",
