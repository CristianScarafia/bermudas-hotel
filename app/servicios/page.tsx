...
export default function ServicesPage() {
  return <><Header overlay /><main id="contenido">
    ...
    <section className="service-story section"><div className="container story-grid"><div className="story-image reveal"><Image src="/images/habitacion-doble-hotel-bermudas-mar-del-plata.webp" alt="Habitación doble renovada y equipada del Hotel Bermudas" width={1800} height={1350} sizes="(max-width: 720px) 100vw, 55vw" unoptimized /></div><div className="story-content reveal"><p className="eyebrow">Calidez Bermudas</p><h2>La atención también es parte del viaje.</h2><p>Somos un hotel familiar y nos importa que cada huésped se sienta acompañado. Por eso ofrecemos atención directa antes, durante y después de la reserva.</p><a className="button button-dark" href="https://wa.me/542236076020" target="_blank" rel="noreferrer">Hablar con el hotel</a></div></div></section>
